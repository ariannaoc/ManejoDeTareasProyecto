...
const TABS = [
  { title: "Detalles", icon: <FaTasks /> },
  //{ title: "Actividades", icon: <RxActivityLog /> },
];
...
const act_types = [
  ...
  "En Progreso",
  "Comentado",
  "Bug", //no se para que en esta esto en una de las plantillas
  "Asignado",
];
            ...
            <div className='w-full flex flex-col md:flex-row gap-5 2xl:gap-8 bg-white shadow-md p-8 overflow-y-auto'>
              ...
              <div className='w-full md:w-1/2 space-y-8'>
                ...
                <p className='text-gray-500'>
                  Creado: {new Date(task?.date).toDateString()} 
                </p> {/*hay que arreglar la fecha que esta en ingles*/}
