...
import { PRIORITY_STYLES, TASK_TYPE } from "../utilidades";
...
const Eliminados = () => {
  ...
  const restoreClick = (id) => {
    setSelected(id);
    setType("restore");
    setMsg("Quieres restaurar el item seleccionado?");
    setOpenDialog(true);
  };
  ...
  const TableHeader = () => (
    <thead className='border-b border-gray-300'>
      <tr className='text-black  text-left'>
        ...
        <th className='py-2 line-clamp-1'>Modificado</th>
      </tr>
    </thead>
  );
