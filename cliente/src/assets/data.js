//la idea aqui es que sigan el formato de los objetos para que puedan funcionar sin cambiar nada del frontend, solo creen los perfiles de esa manera
...
export const summary = {
    ...
    users: [
      {
        ...
        name: "Usuario", //placeholder para el agregar tarea se vea bien y no nombres de usuarios
        title: "Designer",
        role: "Developer",
        isActive: true,
  ...
  //aqui fue el ejemplo para que cambien las fichas de tablero 
  export const tasks = [
    {
      _id: "65c5f12ab5204a81bde866a9",
      title: "Test task",
